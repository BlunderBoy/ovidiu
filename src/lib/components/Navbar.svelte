...
<header
   class="absolute top-5 left-1/2 -translate-x-1/2 w-[90%] md:w-[70%] lg:w-[75%] lg:max-w-screen-xl border z-40 rounded-2xl flex justify-between items-center p-2 bg-card shadow-md dark:shadow-dark shadow-light"
>
  ...
  <div class="flex items-center lg:hidden">
    <Sheet bind:open={isOpen}>
      <SheetTrigger>
        <Menu on:click={() => (isOpen = true)} class="cursor-pointer mr-3" />
      </SheetTrigger>
